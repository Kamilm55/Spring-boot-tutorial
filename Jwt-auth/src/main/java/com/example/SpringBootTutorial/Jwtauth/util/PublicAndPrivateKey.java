...
public class PublicAndPrivateKey {
    ...
    private PrivateKey preparePrivateKey() {
        try {
            ...
            // Learn: read => https://copyprogramming.com/howto/ioexception-algid-parse-error-not-a-sequence

            return prKey;
        } catch (NoSuchAlgorithmException | InvalidKeySpecException e) {
            System.out.println("ALINMADI PRIVATE");
            e.printStackTrace();
        }
        return null;
    }
    ...
    private PublicKey preparePublicKey() {
        try {
            ...
            System.out.println("ALINMADI PUBLIC");
            e.printStackTrace();
        }
        return null;
    }
